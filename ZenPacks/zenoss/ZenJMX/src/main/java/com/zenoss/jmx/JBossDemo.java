 ...
 */
public class JBossDemo {
  // JMX URL to connect to and interrogate
  public static final String URL = 
    "service:jmx:rmi:///jndi/rmi://localhost:12345/jmxrmi";

  // authentication information
  public static final String USERNAME = "monitorRole";
  public static final String PASSWORD = "QED";


  // single-value mbean and attribute
  public static final String SINGLE_VALUE_MBEAN = 
    "jboss.web:type=ThreadPool,name=ajp-127.0.0.1-8009";
  public static final String SINGLE_VALUE_ATTRIBUTE = "maxThreads";
  ...
  public static final String OPERATION_NAME = "getLoggerLevel";
  ...
  // logger
  private static final Log _logger = LogFactory.getLog(JBossDemo.class);
  ...
  public static void start()
    ...
    _logger.info("jboss multi-value output: " + result);
    ...
    _logger.info("jboss operation output: " + o);
  }  
}
